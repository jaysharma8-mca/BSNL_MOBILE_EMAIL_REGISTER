...
public class Co_Pending_List_Activity extends AppCompatActivity implements Co_List_Adapter.ContactsAdapterListener, View.OnClickListener {
    ...
    private Co_Pending_List_SQLiteHelper co_pending_list_sqLiteHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co_pending_list_activity);
        ...
        toolbar1.setTitle("PENDING WL");
        setSupportActionBar(toolbar1);

        tv = new TextView(this);

        co_pending_list_sqLiteHelper = new Co_Pending_List_SQLiteHelper(getApplicationContext());
        final String[] myData = co_pending_list_sqLiteHelper.SelectAllTableData();
    ...
    private void sqlite() {
        ...
        co_pending_list_sqLiteHelper.deleteUsers();
        ...
        if (list1 != null && list2 != null && list3 != null && list4 != null &&
            ...
            for (int i = 0; i < list15.size(); i++) {
                ...
                co_pending_list_sqLiteHelper.addUser(list1.get(i), list2.get(i), list3.get(i), list4.get(i), list5.get(i),
        ...
        co_pending_list_sqLiteHelper.close();
    }

    @SuppressLint("SetTextI18n")
    public void readFromLocalStorage() {

        co_pending_list_sqLiteHelper.open();

        co_list_reportClasses.clear();
        Co_Pending_List_SQLiteHelper co_pending_list_sqLiteHelper = new Co_Pending_List_SQLiteHelper(this);
        SQLiteDatabase database = co_pending_list_sqLiteHelper.getReadableDatabase();

        Cursor cursor = co_pending_list_sqLiteHelper.readFromLocalDatabase(database);
        ...
        while (cursor.moveToNext()) {
            ...
            if (mAdapter != null) {
                ...
                tv.setOnClickListener(Co_Pending_List_Activity.this);
...
//Toast.makeText(getApplicationContext(),"Else Part",Toast.LENGTH_LONG).show();
        if(checkInternetConnection()) {
            if (sdewl != null) {
                ...
                String URL = "https://fms.bsnl.in/fmswebservices/rest/gogreen/costatuslist/updatedby/" + pernolm + "/flag/N";
                ...
                String URL = "https://fms.bsnl.in/fmswebservices/rest/gogreen/costatuslist/updatedby/" + personal_number + "/flag/N";
                URL = URL.replaceAll(" ", "%20");
    ...
    private void retrieveDetails() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(Co_Pending_List_Activity.this);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(Co_Pending_List_Activity.this,Co_List_Activity.class);
