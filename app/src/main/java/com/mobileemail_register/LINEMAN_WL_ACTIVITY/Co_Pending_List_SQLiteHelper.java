...
public class Co_Pending_List_SQLiteHelper extends SQLiteOpenHelper {

    private static final String TAG = Co_Pending_List_SQLiteHelper.class.getSimpleName();

    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_CO_PENDING_LIST = "TABLE_CO_PENDING_LIST";
    ...
    public Co_Pending_List_SQLiteHelper(Context context) {
        super(context, TABLE_CO_PENDING_LIST, null, DATABASE_VERSION);
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_CO_PENDING_LIST + "("
                + SSA + " TEXT,"
                + CUST_ACCNT_NO + " TEXT,"
                + GO_GREEN + " TEXT,"
                + STATUS_FLAG + " TEXT,"
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_CO_PENDING_LIST);
    ...
    void addUser(String ssa, String cust_accnt_no, String go_green, String status_falg,
        ...
        long id = db.insert(TABLE_CO_PENDING_LIST, null, values);
        db.close();
    ...
    String[] SelectAllTableData() {
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("SELECT * FROM " + TABLE_CO_PENDING_LIST , null);
    ...
    void deleteUsers() {
        SQLiteDatabase db = this.getWritableDatabase();
        db.delete(TABLE_CO_PENDING_LIST, null, null);
        db.close();
    ...
    Cursor readFromLocalDatabase(SQLiteDatabase database)
    {
        ...
        return database.rawQuery("SELECT * FROM  TABLE_CO_PENDING_LIST", null);
    }
    ...
    long getProfilesCount() {
        ...
        long count = DatabaseUtils.queryNumEntries(db, TABLE_CO_PENDING_LIST);
        db.close();
        return count;
    }
